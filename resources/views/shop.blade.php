...
<main class="pt-90">
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="2500" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="$" />
              <div class="price-range__info d-flex align-items-center mt-2">
                ...
                <div>
                  ...
                  <span class="price-range__max">$2500</span>
                </div>
              </div>
            </div>
          </div>
  ...
  <form id="frmfilter" method="GET" action="{{ route('shop.index') }}">
      ...
      <input type="hidden" name="max" id="hdnManPrice" value="{{$max_price}}"/>
  </form>
...
<script>
  $(function(){
    $('#pagesize').on("change", function(){
      ...
      var selectedSize = $('#pagesize option:selected').val();
    ...
    $('#orderby').on("change", function(){
      // Get the selected value from the dropdown
      var selectedSize = $('#orderby option:selected').val();

      // Set it in the hidden input
      $("#order").val(selectedSize);

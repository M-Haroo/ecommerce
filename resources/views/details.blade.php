      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
            ...
            <form method="POST" action="{{route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId])}}" id="remove-wishlist-{{$product->id}}">
              @csrf
              @method('DELETE')
              <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heaart"
                onclick="document.getElementById('remove-wishlist-{{$product->id}}').submit();">
              ...
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.details',['product_slug'=>$rproduct->slug])}}">
                  <img loading="lazy" src="{{asset('uploads/products')}}/{{$rproduct->image}}" width="330" height="400"
                    ...
                    @foreach ( explode(",", $product->image) as $gimag )
